...
;;;;; Org
       ...
       `(org-level-1                         ((,class (:foreground ,jbeans-green-5 :weight bold))))
       `(org-level-2                         ((,class (:foreground ,jbeans-orange-0 :weight bold))))
       `(org-level-3                         ((,class (:foreground ,jbeans-orange-0))))
