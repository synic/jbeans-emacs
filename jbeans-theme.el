...
;;;;; Magit
       `(magit-blame-heading                 ((,class (:background ,jbeans-green-8 :foreground ,jbeans-bg))))
       `(magit-bisect-bad                    ((,class (:foreground ,jbeans-red-6))))
       `(magit-bisect-good                   ((,class (:foreground ,jbeans-green-4))))
       `(magit-bisect-skip                   ((,class (:foreground ,jbeans-orange-1))))
       `(magit-blame-date                    ((,class (:inherit magit-blame-heading))))
       `(magit-blame-hash                    ((,class (:inherit magit-blame-heading))))
       `(magit-blame-name                    ((,class (:inherit magit-blame-heading))))
       ...
       `(magit-diff-file-heading-selection   ((,class (:background  ,jbeans-bg :foreground ,jbeans-grey-11))))
       `(magit-diff-hunk-heading             ((,class (:background ,jbeans-bg :box ,jbeans-grey-4  :foreground ,jbeans-fg :weight bold))))
       `(magit-diff-hunk-heading-highlight   ((,class (:background  ,jbeans-bg :box ,jbeans-grey-10 :weight bold :foreground  ,jbeans-fg))))
       ...
       `(magit-diff-lines-heading            ((,class (:inherit magit-diff-hunk-heading-highlight :background ,jbeans-red-7 :foreground ,jbeans-grey-11))))
       ...
       `(magit-filename                      ((,class (:foreground ,jbeans-orange-1 :weight normal))))
       ...
       `(magit-log-graph                     ((,class (:foreground ,jbeans-grey-11))))
       ...
       `(magit-refname                       ((,class (:background  ,jbeans-bg :foreground ,jbeans-grey-11))))
