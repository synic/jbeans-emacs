...
;;;;; Org
       ...
       `(org-level-1                         ((,class (:foreground ,jbeans-yellow-3))))
       `(org-level-2                         ((,class (:foreground ,jbeans-yellow-1))))
       `(org-level-3                         ((,class (:foreground ,jbeans-yellow-1))))
